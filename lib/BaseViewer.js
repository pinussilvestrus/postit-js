...
import postitDescriptors from './moddle/descriptors.json';


/**
 * A base viewer for Postit diagrams.
 *
...
BaseViewer.prototype.open = function(bpmnDiagramOrId, done) {
  ...
  return importPostitDiagram(this, definitions, bpmnDiagram, done);
};
...
function checkValidationError(err) {
  ...
  if (match) {
    err.message =
      ...
      'this may indicate an invalid Postit diagram file' + match[2];
  }
