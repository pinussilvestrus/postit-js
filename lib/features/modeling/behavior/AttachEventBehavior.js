 ...
 */
export default function AttachEventBehavior(postitReplace, injector) {
...
AttachEventBehavior.prototype.replaceShape = function(shape, host) {
  ...
  return this._postitReplace.replaceElement(shape, boundaryEvent, { layoutConnection: false });
};
