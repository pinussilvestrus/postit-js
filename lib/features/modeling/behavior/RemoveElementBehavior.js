...
export default function RemoveElementBehavior(eventBus, postitRules, modeling) {
  ...
  this.preExecute('shape.delete', function(e) {
    ...
    if (postitRules.canConnect(inConnection.source, outConnection.target, inConnection)) {
