...
PostitUpdater.prototype.updateFlowNodeRefs = function(businessObject, newContainment, oldContainment) {
...
PostitUpdater.prototype.updateDiConnection = function(di, newSource, newTarget) {
...
PostitUpdater.prototype.getLaneSet = function(container) {
  ...
  if (is(container, 'bpmn:Lane')) {
    ...
    if (!laneSet) {
      laneSet = this._postitFactory.create('bpmn:LaneSet');
...
PostitUpdater.prototype.updateConnectionWaypoints = function(connection) {
  connection.businessObject.di.set('waypoint', this._postitFactory.createDiWaypoints(connection.waypoints));
};


PostitUpdater.prototype.updateConnection = function(context) {
