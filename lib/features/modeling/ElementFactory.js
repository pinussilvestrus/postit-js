...
ElementFactory.prototype.createBpmnElement = function(elementType, attrs) {
  ...
  if (!businessObject.di) {
    ...
    if (elementType === 'connection') {
      businessObject.di = this._postitFactory.createDiEdge(businessObject, [], {
        id: businessObject.id + '_di'
      });
    } else {
  ...
  if (attrs.eventDefinitionType) {
    ...
    newEventDefinition = this._postitFactory.create(attrs.eventDefinitionType, attrs.eventDefinitionAttrs);

    if (attrs.eventDefinitionType === 'bpmn:ConditionalEventDefinition') {
      newEventDefinition.condition = this._postitFactory.create('bpmn:FormalExpression');
    }
...
ElementFactory.prototype.createParticipantShape = function(attrs) {
  ...
  if (attrs.isExpanded !== false) {
    attrs.processRef = this._postitFactory.create('bpmn:Process');
  }
