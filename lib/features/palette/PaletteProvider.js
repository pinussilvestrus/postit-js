...
export default function PaletteProvider(
    palette, canvas, create, modeling, elementFactory,
...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  function createImage() {
    ...
    var source = prompt(translate('Input an image url'), '');
    ...
    var imageShape = elementFactory.createShape({
      type: 'postit:Image',
      source: source
    });

    modeling.createShape(imageShape, {
      x: 400,
      y: 400
    }, root);
  }
